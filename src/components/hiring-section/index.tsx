          ...
          <div className={tw(`w-full lg:w-2/3`)}>
            <div className={tw(`flex flex-col lg:ml-10`)}>
              <div className={tw(`flex items-center border-b border-teal-500 py-2`)}>
                <input className={tw(`appearance-none bg-transparent border-null w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none`)} type="text" placeholder="Your Name" aria-label="Full name" />
              </div>
              <div className={tw(`flex items-center border-b border-teal-500 py-2 mt-5`)}>
                <input className={tw(`appearance-none bg-transparent border-null w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none`)} type="text" placeholder="Your Email" aria-label="Full email" />
              </div>
              <div className={tw(`flex items-center border-b border-teal-500 py-2 mt-5`)}>
                <input className={tw(`appearance-none bg-transparent border-null w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none`)} type="text" placeholder="Your Phone Number" aria-label="Full phone number" />
              </div>
              <div>
              </div>
            </div>
