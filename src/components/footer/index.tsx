...
const Footer = () => (
  <footer className={tw(`bg-black`)} aria-labelledby="footerHeading">
    ...
    <div className={tw('max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8')}>
      <div className={tw('xl:grid xl:grid-cols-3 xl:gap-8')}>
        <div className={tw('space-y-8 xl:col-span-1')}>
          {/* <Tarabol className={tw('h-10')} /> */}
          <p className={tw('text-white decoration-solid font-bold')}>
            Tarabol Co ., Ltd
          </p>
  ...
  //       <img className={tw(`h-12 w-12 mr-4`)} src="logo.svg" alt="logo" width={192} height={192} />
  //       <p className={tw(`text-4xl text-indigo-500 font-bold`)}></p>
  //     </div>
